...
$(function($) {
	...
	$('.has-children>a').on('click', function(event){
		event.preventDefault();
		$(this).find('.has-children').toggleClass('open');
		$(this).parent().find('.child-nav').slideToggle('500');
	});

	$('.has-children-2').not('.open').find('.child-nav-2').slideUp('100');
	$('.has-children-2>a').on('click', function(event){
		event.preventDefault();
		$(this).parent().toggleClass('open');
		$(this).parent().find('.child-nav-2').slideToggle('500');
	});
